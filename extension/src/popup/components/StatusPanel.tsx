...
export const StatusPanel: React.FC<StatusPanelProps> = ({
  ...
  return (
    <div className="card">
      ...
      {!isPocketOptionOpen && isConnected && (
        <div className="warning-box" style={{ marginTop: '8px', background: '#ff910022', borderColor: '#ff910044' }}>
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 600, marginBottom: '2px', color: '#ff9100' }}>Open Pocket Option to enable trading</div>
          </div>
          <a
